    ...
    return (
        <Box
            ...
            sx={{
                ...
                display: "flex",
                justifyContent: `${
                    message.senderEmail !== currentSender ? "flex-start" : "flex-end"
                }`,
                mb: "10px",
            }}
        >
            <Box
                sx={{
                    ...
                    borderRadius: "10px",
                    backgroundColor: `${
                        message.senderEmail !== currentSender
                    ...
                    color: `${
                        message.senderEmail !== currentSender ? "black" : "white"
                    } !important`,
                }}
            >
...
const Chat = ({ticket}) => {
    ...
    const handleSendMessage = (messageText, attachedFile = null) => {
        ...
        const message = {
            ...
            ticket: ticket.id,
            senderEmail: (currentUser?.email).trim(),
            senderName: (currentUser?.name).trim() + " " + (currentUser?.surname).trim(),
